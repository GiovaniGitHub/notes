...
def get_coef_with_gradient(x,y, degrees, epochs, lr, func_adjust, batch = None, is_stochastic = False):
...
if __name__ == "__main__":
    ...
    y_hat_gradient_batch = dot(expand_matrix(X, 5, 1), weights_gd_batch) + linear_coef_bd_batch
